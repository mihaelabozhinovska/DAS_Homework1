...
public class LstmAi {
    ...
    public Double predictNextMonth(Long companyId) {
        ...
        List<PriceSnapshotEntity> data = priceSnapshotRepository.findByCompanyIdAndDateBetween(companyId, LocalDate.now().minusMonths(1), LocalDate.now());;
    ...
    public static List<Map<String, Object>> mapToRequestData(List<PriceSnapshotEntity> historicalDataEntities) {
