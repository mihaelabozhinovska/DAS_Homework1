...
public class F3Price implements Filter<List<StockIssuerEntity>> {
    ...
    public F3Price(StockIssuerRepository stockIssuerRepository, PriceSnapshotRepository priceSnapshotRepository) {
        this.stockIssuerRepository = stockIssuerRepository;
        this.priceSnapshotRepository = priceSnapshotRepository;
    }

    public List<StockIssuerEntity> execute(List<StockIssuerEntity> input) throws IOException, ParseException {
