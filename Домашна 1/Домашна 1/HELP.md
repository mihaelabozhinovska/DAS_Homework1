...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.3.5/reference/tradeHistory/sql.html#tradeHistory.sql.jdbc)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.3.5/reference/tradeHistory/sql.html#tradeHistory.sql.jpa-and-spring-tradeHistory)
...
* [Using Spring Data JDBC](https://github.com/spring-projects/spring-tradeHistory-examples/tree/master/jdbc/basics)
* [Accessing Data with JPA](https://spring.io/guides/gs/accessing-tradeHistory-jpa/)
